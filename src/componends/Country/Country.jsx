...
const Country = ({ country, isVisited, handleVisitedCountries }) => {
  ...
  const population =
    country?.population?.population ?? country?.population ?? "N/A";
  ...
  const continents =
    country?.continents?.continents || country?.continents || [];
      ...
      <div className="country-body">
        ...
        <div className="country-stats">
          ...
          <p>
            <span>Capital</span>
            <strong>
              {Array.isArray(capital) ? capital.join(", ") || "N/A" : capital}
            </strong>
          </p>
          <p>
            <span>Continent</span>
          ...
          <p>
            <span>Languages</span>
            <strong>{languages.length ? languages.join(", ") : "N/A"}</strong>
          </p>
        </div>
